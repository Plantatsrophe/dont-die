 ...
 */
export function drawFiberStrands(points: {x:number, y:number}[] | undefined, strandCount: number, colorHue: number, isFlipped: boolean, alpha: number = 0.8, boss?: IBoss, isMedusa: boolean = false, broadness: number = 1.0, tallness: number = 0.0, baseSpread: number = 0.0, isVertical: boolean = false) {

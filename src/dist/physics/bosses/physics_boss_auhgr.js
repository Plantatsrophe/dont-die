 ...
 */
export function updateAuhGr(boss, dt) {
    ...
    for (let i = G.enemies.length - 1; i >= 0; i--) {
        ...
        if (e.y > boss.y) {
            ...
            for (let k = 0; k < 30; k++) {
                ...
                p.active = true;
                p.type = 'normal';
                p.x = e.x + Math.random() * 24;
                p.y = e.y + Math.random() * 24;
                p.vx = (Math.random() - 0.5) * 500;
                p.vy = -150 - Math.random() * 300;
    ...
    for (let i = G.items.length - 1; i >= 0; i--) {
        ...
        if (!it.collected && it.y > boss.y) {
            ...
            for (let k = 0; k < 20; k++) {
                ...
                p.active = true;
                p.type = 'normal';
                p.x = it.x + Math.random() * 32;
                p.y = it.y + Math.random() * 32;

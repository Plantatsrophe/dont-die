import { G, TILE_SIZE, getNextParticle, player } from './globals.js';
 ...
 */
export function handleSepticusDeath(boss, dt, bDyn) {
    if (bDyn.isDying) {
        boss.timer += dt;
 ...
 */
export function updateSepticusProjectiles(boss, dt) {
    if (!boss.projs)
        return;

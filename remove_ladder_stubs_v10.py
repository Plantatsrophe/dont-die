    ...
    for r in range(num_rows):
        for c in range(num_cols):
            if grid[r][c] in ladder_types:
                ...
                has_ladder_above = (r > 0 and grid[r-1][c] in ladder_types)
                has_ladder_below = (r < num_rows - 1 and grid[r+1][c] in ladder_types)
...
print("Single-tile ladder sanitization complete.")

...
def upgrade_ladders(map_rows):
    ...
    # Scan for ladder columns
    for c in range(num_cols):
        for r in range(num_rows):
            if grid[r][c] == '2' or grid[r][c] == '9':
                # Check tile above
                curr_r = r - 1
                while curr_r >= 0 and grid[curr_r][c] in ['1', '6']:
                    ...
                    # But we stop if we hit air '0' or something else
...
print("Ladder-to-Platform hybrid upgrade complete.")
